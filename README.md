...
6. API 실패와 비정상 응답은 조용히 무시하지 않고 명시적인 오류로 남깁니다.
...
```powershell
kis-scan scan --top 10 --min-change 1.5 --max-change 15 --min-value-krw 3000000000
```
...
1. 신호와 사후 수익률을 SQLite/PostgreSQL에 저장
